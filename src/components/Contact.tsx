    ...
    try {
      ...
      if (error) {
        ...
        if (
          ...
          setSubmissionError("Table 'contact' does not exist in your Supabase project schema cache yet.");
          setSqlInstructions(
            "-- 1. Run this script in the Supabase SQL Editor to create the 'contact' table:\n" +
        ...
        // Handle Row-Level Security (RLS) policy errors
          ...
          setSubmissionError("Row-Level Security (RLS) is active on your 'contact' table, but there is no policy that allows public inserts.");
          setSqlInstructions(
            "-- Run this script in your Supabase SQL Editor to allow public form submissions:\n\n" +
          ...
          setSubmissionError(error.message || 'Failed to submit inquiry to Supabase.');
        }
      } else {
        setIsSuccess(true);
      }
